...
num_interps =  3360# the number of interpolations between each two consectuve images, basically FPS x seconds 14 83
num_interps_images = 2#the number of images, or number of images to be ping ponged
...
selection = [22,23,24,127,128,129,294,295,296,297,292,345,346,347,348,349,350,351,352,353,147,148,149]
    ...
    for f in range(0,200):
        ...
        for i in range(0, num_interps_images):
            ...
            for i in range(0, len(interps_z)):
                ...
                filedir = os.path.join('./selection',filename)
        ...
        video = cv2.VideoWriter(filename, fourcc, 120, (512,512))
